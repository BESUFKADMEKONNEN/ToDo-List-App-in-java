...
public class FinishedActivity extends NavParent {
    @Override
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if (!dataSnapshot.hasChildren()) {
                            Toast.makeText(FinishedActivity.this, "No tasks to display!", Toast.LENGTH_SHORT).show();
                            return;
                        }
                        ...
                        for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                            ...
                            if (taskData != null) {
                                ...
                                if (isChecked != null && isChecked) { // Only show tasks where isChecked is true
                                            ...
                                            tasksRef.child(taskId).child("isChecked").setValue(isCheckedNow)
                                                    .addOnCompleteListener(task -> {
                                                        if (task.isSuccessful()) {
                                                            Toast.makeText(FinishedActivity.this,  isCheckedNow?"Task Completed":"Task is not Completed", Toast.LENGTH_SHORT).show();
                                                            fetchTasksFromDatabase();  // ✅ Refetch data after update
                                                        } else {
                                                            Toast.makeText(FinishedActivity.this, "Failed to update task", Toast.LENGTH_SHORT).show();
                                                        }
                                                    });
                                        }
                                        fetchTasksFromDatabase();
                                    ...
                                    taskView.setOnClickListener(v -> {
                                        Intent intent = new Intent(FinishedActivity.this, TaskDetailActivity.class);
                                    ...
                                    taskView.setOnLongClickListener(v -> {
                                        new androidx.appcompat.app.AlertDialog.Builder(FinishedActivity.this)
                                                    ...
                                                    if (taskId != null) {
                                                        tasksRef.child(taskId).removeValue()
                                                                .addOnSuccessListener(aVoid -> {
                                                                    ...
                                                                    Toast.makeText(FinishedActivity.this, "Task deleted", Toast.LENGTH_SHORT).show();
                                                                    fetchTasksFromDatabase(); // Refresh UI
                                                                })
                                                                .addOnFailureListener(e -> {
                                                                    // An error occurred during the deletion
                                                                    Toast.makeText(FinishedActivity.this, "Failed to delete task", Toast.LENGTH_SHORT).show();
                    ...
                    public void onCancelled(DatabaseError databaseError) {
                        Toast.makeText(FinishedActivity.this, "Failed to load tasks.", Toast.LENGTH_SHORT).show();
                    }
                });
    }
}